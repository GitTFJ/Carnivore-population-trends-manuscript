species_int = readRDS("Documents/ModellingTrends/Data/Phylogeny/SpeciesIntercept.rds")[,c(2,3)]
colnames(species_int) = c("Species_intercept", "Species")
genus_int = readRDS("Documents/ModellingTrends/Data/Phylogeny/GenusIntercept.rds")[,c(2,3)]
colnames(genus_int) = c("Genus_intercept", "Genus")
region_int = readRDS("Documents/ModellingTrends/Data/regionIntercept.rds") [,c(4,1)]
colnames(region_int) = c("Region_intercept", "Conts")
country_int = readRDS("Documents/ModellingTrends/Data/countryIntercept.rds")[,c(4,6)]
...
jpeg("Documents/ModellingTrends/Results/scen_plot.jpeg", width = 5, height = 8, units = "in", res = 300)
