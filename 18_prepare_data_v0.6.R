m1 = readRDS("Documents/ModellingTrends/Data/Analysis/ErrorModel.rds")
ihs <- function(x) {
  y <- log(x + sqrt(x ^ 2 + 1))
  return(y)
}
...
ggsave("Documents/ModellingTrends/Results/qual_quan_space.png", width = 9, height = 5, dpi = 500)
