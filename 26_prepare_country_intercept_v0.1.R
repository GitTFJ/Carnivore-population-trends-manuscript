...
country = read.csv("Documents/ModellingTrends/Data/CountryData/CountryContinent.csv")
...
saveRDS(regs_dic, "Documents/ModellingTrends/Data/countryIntercept.rds")


world = read_sf("Documents/ModellingTrends/Data/UN_subregion/TM_WORLD_BORDERS-0.3.shp")
...
plot(world_rst)
saveRDS(world_rst, "Documents/ModellingTrends/Data/UN_subregion/country_rast.rds")
