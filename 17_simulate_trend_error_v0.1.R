...
ggsave("Documents/ModellingTrends/Results/example_simultating_weights.png", width = 5, height = 5)
...
ggsave("Documents/ModellingTrends/Results/simulated_trend_dist.png", width = 8, height = 3)
...
plot(m1)
hist(residuals(m1))
saveRDS(m1, "Documents/ModellingTrends/Data/Analysis/ErrorModel.rds")
...
ggsave("Documents/ModellingTrends/Results/simulated_effects.png", width = 8, height = 3)
n