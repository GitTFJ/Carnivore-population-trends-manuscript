...
jpeg("Documents/ModellingTrends/Results/model_fit.jpeg", width = 9, height = 3, units = "in", res = 300)
...
ggsave("Documents/ModellingTrends/Results/rvi_coefs.png", width = 14, height = 7.5)
...
jpeg("Documents/ModellingTrends/Results/coef_plot.jpeg", width = 12.5, height = 9, units = "in", res = 300)
