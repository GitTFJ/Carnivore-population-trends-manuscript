mod = readRDS("Documents/ModellingTrends/Data/Analysis/full_mod.rds")
...
pdf("Documents/ModellingTrends/Results/convergence.pdf")
plot(converge)
dev.off()
...
c
jpeg("Documents/ModellingTrends/Results/assumption_plot.jpeg", width = 8, height = 6, units = "in", res = 300)
...
jpeg("Documents/ModellingTrends/Results/posterior_check_plot.jpeg", width = 11, height = 8, units = "in", res = 300)
