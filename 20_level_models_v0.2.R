...
#source("Documents/ModellingTrends/Bayesian/Background/quan_wg_a_v1.7.R")
#source("Documents/ModellingTrends/Bayesian/Background/man_wg_a_v1.7.R")

full_wg_a = readRDS("Documents/ModellingTrends/Data/Analysis/full_wg_a.rds")
quan_wg_a = readRDS("Documents/ModellingTrends/Data/Analysis/quan_wg_a.rds")
man_wg_a = readRDS("Documents/ModellingTrends/Data/Analysis/man_wg_a.rds")
...
ggsave("Documents/ModellingTrends/Results/level_fit.png", width = 12, height = 7)
