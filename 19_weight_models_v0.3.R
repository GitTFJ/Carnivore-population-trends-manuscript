...
#source("Documents/ModellingTrends/Bayesian/Background/full_unw_v1.7.R")
#source("Documents/ModellingTrends/Bayesian/Background/full_nobs_v1.7.R")
#source("Documents/ModellingTrends/Bayesian/Background/full_wg_a_v1.7.R")

full_unw = readRDS("Documents/ModellingTrends/Data/Analysis/full_unw.rds")
full_nobs = readRDS("Documents/ModellingTrends/Data/Analysis/full_nobs.rds")
full_wg_a = readRDS("Documents/ModellingTrends/Data/Analysis/full_wg_a.rds")
...
df = round(df,3)
write.csv(df, "Documents/ModellingTrends/Results/weight_fit.csv")
...
ggsave("Documents/ModellingTrends/Results/weight_fit.png", width = 12, height = 7)
